...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsIndexPage = __webpack_require__(198);

	var _componentsIndexPage2 = _interopRequireDefault(_componentsIndexPage);

	var _componentsAboutPage = __webpack_require__(207);

	var _componentsAboutPage2 = _interopRequireDefault(_componentsAboutPage);

	var _componentsIdeaPage = __webpack_require__(208);

	var _componentsIdeaPage2 = _interopRequireDefault(_componentsIdeaPage);

	__webpack_require__(209);

	var gh_access_token = _utils2['default'].query().gh_access_token;
	if (gh_access_token) {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            'Show off your ideas, inventions and innovations!'
	          )
	        ),
	...
	var routes = _react2['default'].createElement(
	  _reactRouter.Route,
	  { handler: App },
	  _react2['default'].createElement(_reactRouter.Route, { path: '/', handler: _componentsIndexPage2['default'] }),
	  _react2['default'].createElement(_reactRouter.Route, { path: 'about', handler: _componentsAboutPage2['default'] }),
	  _react2['default'].createElement(_reactRouter.Route, { name: 'idea', path: 'idea/:number', handler: _componentsIdeaPage2['default'] })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactDocumentTitle = __webpack_require__(199);

	var _reactDocumentTitle2 = _interopRequireDefault(_reactDocumentTitle);

	var _Ideas = __webpack_require__(203);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2),
	    withSideEffect = __webpack_require__(200);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ideas = (function (_Component) {
	  ...
	  function Ideas() {
	    ...
	    _get(Object.getPrototypeOf(Ideas.prototype), 'constructor', this).apply(this, arguments);
	  ...
	  _createClass(Ideas, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      var gh_token = _utils2['default'].gh_token();
	      _superagent2['default'].get('https://api.github.com/repos/LightBulb/LightBulb/issues?access_token=' + gh_token).end(function (err, res) {
	        var ideas = JSON.parse(res.text);
	        _this.setState({
	          ideas: ideas
	        });
	      });
	    ...
	    value: function render() {
	      var ideas = this.state.ideas.map(function (idea) {
	        return _react2['default'].createElement(
	          'div',
	          { className: 'idea', key: idea.number },
	          _react2['default'].createElement(
	            'h3',
	            null,
	            _react2['default'].createElement(
	              _reactRouter.Link,
	              { to: 'idea', params: { number: idea.number } },
	              idea.title
	            )
	          )
	        );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IdeaPage = (function (_Component) {
	  _inherits(IdeaPage, _Component);

	  function IdeaPage() {
	    _classCallCheck(this, IdeaPage);

	    _get(Object.getPrototypeOf(IdeaPage.prototype), 'constructor', this).apply(this, arguments);
	  }
